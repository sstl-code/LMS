...
COMMENT ON COLUMN tb_siteagreement.status IS '1 - Active, 0 - Pending, 2 - Deleted, 3 - Archived / Expired'|
...
INSERT INTO sa_attribute (attributename, attributetype, attributedatatype, mandatory, defaultvalue, flov) VALUES('Contact No 2', 8, 1, 0, '', '')|
INSERT INTO sa_attribute (attributename, attributetype, attributedatatype, mandatory, defaultvalue, flov) VALUES('Whatsapp No', 8, 1, 0, '', '')|
...
INSERT INTO sa_attribute (attributename, attributetype, attributedatatype, mandatory, defaultvalue, flov) VALUES('State', 8, 5, 1, ' Delhi', 'Andhra Pradesh , Arunachal Pradesh , Assam, Bihar , Chhattisgarh , Goa ,Delhi, Gujarat , Haryana , Himachal Pradesh , Jharkhand , Karnataka , Kerala , Madhya Pradesh , Maharashtra , Manipur , Meghalaya, Mizoram , Nagaland , Odisha , Punjab , Rajasthan , Sikkim  ,Tamil Nadu , Telangana , Tripura,Uttarakhand,Uttar Pradesh,West Bengal ')|
...
INSERT INTO sa_attribute (attributename, attributetype, attributedatatype, mandatory, defaultvalue, flov) VALUES('Bank Account Number Rental', 8, 1, 1, '', '')|
...
INSERT INTO sa_attribute (attributename, attributetype, attributedatatype, mandatory, defaultvalue, flov) VALUES('Bank Name Rental', 8, 3, 1, '', '')|
...
INSERT INTO sa_attribute (attributename, attributetype, attributedatatype, mandatory, defaultvalue, flov) VALUES('Bank Account Number EB', 8, 1, 0, '', '')|
...
INSERT INTO sa_attribute (attributename, attributetype, attributedatatype, mandatory, defaultvalue, flov) VALUES('Bank Name EB', 8, 3, 0, '', '')|
...
INSERT INTO sa_attribute (attributename, attributetype, attributedatatype, mandatory, defaultvalue, flov) VALUES('TDS', 8, 1, 0, '', '')|
...
INSERT INTO sa_attribute (attributename, attributetype, attributedatatype, mandatory, defaultvalue, flov) VALUES('Project Status', 7, 3, 1, '', '')|
...
INSERT INTO sa_attribute (attributename, attributetype, attributedatatype, mandatory, defaultvalue, flov) VALUES('EB Meter Status', 7, 5, 0, '', 'SEB Meter,Sub Meter,Prepaid Meter,SEB Prepaid Meter')|
...
INSERT INTO sa_attribute (attributename, attributetype, attributedatatype, mandatory, defaultvalue, flov) VALUES('Original Tenure of Lease in Years', 10, 1, 1, 0, '')|
...
COMMENT ON COLUMN crest_invoice_summary.status IS '0-To be Processed, 1-Hold by EMG, 2 - Rejected by EMG, 3-Approved by EMG, 4-Rejected by Finance, 5-Approved by Finance, 6-Sent to SAP, 7-Payment Record Received'|
